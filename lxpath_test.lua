...
function TestTokenizer:test_parse_simple()
    local testdata = {
        ...
        { "avg( () )",                                                           {} },
        { "exists( () )",                                                        { false } },
        { "exists( /root/sub )",                                                 { true } },
        { "exists( /root/doesnotexist )",                                        { false } },
        { "compare( 'abc', 'abd' )",                                             { -1 } },
        { "compare( 'abc', 'abc' )",                                             { 0 } },
        { "compare( 'abd', 'abc' )",                                             { 1 } },
        { "compare( (), 'abc' )",                                                {} },
        ...
        { "index-of( ('a', 'b', 'c'), 'b' )",                                    { 2 } },
        { "index-of( ('a', 'b', 'c'), 'd' )",                                    {} },
        { "subsequence( (1, 2, 3, 4, 5), 2, 3 )",                                { 2.0, 3.0, 4.0 } },
        { "subsequence( (1, 2, 3, 4, 5), 4 )",                                   { 4.0, 5.0 } },
        { "subsequence( (1, 2, 3, 4, 5), 0, 3 )",                                { 1.0, 2.0 } },
        { "subsequence( (), 1, 3 )",                                             {} },
        { "insert-before( ('a', 'b', 'c'), 2, 'x' )",                            { "a", "x", "b", "c" } },
        { "insert-before( ('a', 'b', 'c'), 0, 'x' )",                            { "x", "a", "b", "c" } },
        { "insert-before( ('a', 'b', 'c'), 9, ('x', 'y') )",                     { "a", "b", "c", "x", "y" } },
        { "remove( ('a', 'b', 'c'), 2 )",                                        { "a", "c" } },
        { "remove( ('a', 'b', 'c'), 9 )",                                        { "a", "b", "c" } },
        { "remove( (), 1 )",                                                     {} },
        { "zero-or-one( () )",                                                   {} },
        { "zero-or-one( 'a' )",                                                  { "a" } },
        { "one-or-more( (1, 2) )",                                               { 1.0, 2.0 } },
        { "exactly-one( 'x' )",                                                  { "x" } },
        { [[ replace('abracadabra', 'bra', '*') ]],                              { "a*cada*" } },
        { [[ replace('abracadabra', 'a', '') ]],                                 { "brcdbr" } },
        { [[ replace('darted', '(d)(a)', '$2$1') ]],                             { "adrted" } },
        { [[ replace('100', '0', '%') ]],                                        { "1%%" } },
        { [[ tokenize('a,b,,c', ',') ]],                                         { "a", "b", "", "c" } },
        { [[ tokenize('2006-12-25', '-') ]],                                     { "2006", "12", "25" } },
        { [[ tokenize('abc', 'x') ]],                                            { "abc" } },
        ...
        { [[ deep-equal( 'a', 'a' ) ]],                                          { true } },
        { [[ deep-equal( 1, '1' ) ]],                                            { true } },
        { [[ deep-equal( /root/sub[1], /root/sub[1] ) ]],                        { true } },
        { [[ deep-equal( /root/sub[1], /root/sub[2] ) ]],                        { false } },
        { [[ deep-equal( /root/a[1], /root/a[2] ) ]],                            { false } },
    }
